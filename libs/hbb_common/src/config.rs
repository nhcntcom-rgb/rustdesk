...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("NTCOMRemote".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["103.241.43.58"];
pub const RS_PUB_KEY: &str = "ciXBvlxsECvxiBC6j0Aa6KcGJjrYPSB4IJTyV8+f8q0=";
